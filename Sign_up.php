                          ...
                          <div class="box">
                                  ...
                                  <?php
                                      if(isset($_GET['error']))
                                      {
                                          ...
                                          {
                                              echo '<p class="registererror">Enter Valid Email and Username</p>';
                                          }
                                          else if($_GET['error'] == "invalidEmail")
                                          {
                                              echo '<p class="registererror">Enter Valid Email</p>';
                                          }
                                          else if($_GET['error'] == "invalidUsername")
                                          {
                                              echo '<p class="registererror">Enter Valid Username</p>';
                                          }
                                          else if($_GET['error'] == "passwordsNotMatch")
                                          {
                                              echo '<p class="registererror">Enter same passwords</p>';
                                          }
                                          else if($_GET['error'] == "UsernameTaken")
                                          {
                                              echo '<p class="registererror">Username Already Taken</p>';
                                          }
                                      }
                                  ...
                                  <form action="register_php.php" method="post" enctype = "multipart/form-data">
                                      ...
                                      <div class="inputBox">
                                          <input type="text" name="email" value="<?php if(isset($_GET['mail'])){echo $_GET['mail'];}  ?>">
                                          <label>email</label>
                                      </div>
                                      <div class="inputBox">
                                      ...
                                      <div class="inputBox">
                                          <input type="text" name="question" value="" placeholder = "Enter your Favourite Food">
                                      ...
                                      <h6>Gender</h6>
                                      Male<input type="radio"  id="gender1" name="gender" value="1" ><br>
                                      Female<input type="radio" id="gender1" name="gender" value="2" >
