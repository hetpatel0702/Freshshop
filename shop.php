            ...
            <div class="row">
                                                ...
                                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                                    <div class="products-single fix">
                                                        <div class="box-img-hover">
                                                            ...
                                                            <img src="images/product_photos/'.$row['veg_id'].'.jpg" class="img-fluid" alt="Image" style="width:250px;height:250px;">
                                                            <div class="mask-icon">
                                                                <ul>
                                                                ...
                                                                <a class="cart" href="addtocart.php?vid='.$row['veg_id'].'">Add to Cart</a>
                                                            </div>
                                                        </div>
                                                        <div class="why-text">
                                                            <h4>'.$row['veg_name'].'</h4>
                                                            <h5>Price:'.$row['veg_price'].'</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                      ';
                                                      ...
                                                      <div class="row">
                                                          <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                                              <div class="products-single fix">
                                                                  <div class="box-img-hover">
                                                                      ...
                                                                      <img src="images/product_photos/'.$row['veg_id'].'.jpg" class="img-fluid" alt="Image" style="width:25%;height:25%;">
                                                                      <div class="mask-icon">
                                                                          <ul>
                                                                              <li><a href="#" data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-eye"></i></a></li>
                                                                              <li><a href="#" data-toggle="tooltip" data-placement="right" title="Compare"><i class="fas fa-sync-alt"></i></a></li>
                                                          ...
                                                          <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                              <div class="why-text full-width">
                                                                  ...
                                                                  <a class="btn hvr-hover" href="addtocart.php?vid='.$row['veg_id'].'">Add to Cart</a>
                                                              </div>
                                                          </div>
                                                      </div>
                                                  </div>
				...
				<div class="col-xl-3 col-lg-3 col-sm-12 col-xs-12 sidebar-shop-left">
                    ...
                    <!-- <div class="col-12 col-sm-4 text-center text-sm-right">
                        <ul class="nav nav-tabs ml-auto">
                            <li>
                                Grid View<a class="nav-link active" href="#grid-view" data-toggle="tab"> <i class="fa fa-th"></i> </a>
                            </li>
                            <li>
                                List View<a class="nav-link" href="#list-view" data-toggle="tab"> <i class="fa fa-list-ul"></i> </a>
                            </li>
                        </ul>
                    </div>
                </div> -->
